...
urlpatterns = [
    ...
    path(
        route='posts/<int:post_id>/delete/',
    ...
    path(
        route='posts/<int:post_id>/edit_comment/<int:comment_id>/',
        view=views.CommentUpdateView.as_view(),
        name='edit_comment'
    ),
    path(
        route='posts/<int:post_id>/delete_comment/<int:comment_id>/',
